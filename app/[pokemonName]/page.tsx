      ...
      <div className={"flex flex-col items-center gap-8"}>
        {data ? (
          <div className={"flex flex-col gap-8"}>
            ...
            <div
              className={"flex w-full justify-center m-y-8 bg-slate-200 border border-slate-400 rounded rounded-box p-8"}>
              <p
                className={"break-words max-w-md text-center text-black"}>{species?.flavor_text_entries[0].flavor_text}</p>
            </div>
